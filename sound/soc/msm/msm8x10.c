...
// FelexChing 20130929 QCN patch, fix Sensitivity Rx g/n Fail
...
#define WCD9XXX_MBHC_DEF_BUTTONS 5	//Kevin Shiu only support bottons on 8x10
...
static struct wcd9xxx_mbhc_config mbhc_cfg = {
	...
	.cs_enable_flags = 0, /*(1 << MBHC_CS_ENABLE_POLLING |
			    ...
			    1 << MBHC_CS_ENABLE_REMOVAL),*/ //Kevin Shiu temp fix
...
#define S(X, Y) ((WCD9XXX_MBHC_CAL_PLUG_TYPE_PTR(msm8x10_wcd_cal)->X) = (Y))
	S(v_no_mic, 30);
	S(v_hs_max, 2475); //Kevin Shiu 20140107 increase mic voltage to 2.7v
#undef S
...
#undef S
	...
	//Kevin Shiu 20140107 increase mic voltage to 2.7v
	btn_low[0] = -50;
	btn_high[0] = 100; //Kevin Shiu 20140410 support Samsung Galaxy S4 kitting earphone
	btn_low[1] = 101;
	btn_high[1] = 375;
	btn_low[2] = 376;
	btn_high[2] = 750;
